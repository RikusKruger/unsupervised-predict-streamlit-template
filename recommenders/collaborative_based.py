...
(preds, model) = dump.load('resources/models/SVD_app.pkl')
...
def collab_model(movie_list,top_n=10):
    ...
    movietitle = pd.merge(ratings_df, movies_df, on= 'movieId', how = 'left')
    movietitle = movietitle.drop(['genres','rating','userId'], axis = 1)
